...
import {makeElement, isInPage, isEscEvent} from './util.js';
...
document.querySelector('.leaflet-marker-pane').addEventListener('keydown', (evt) => {
  if (isEscEvent(evt)) {
    evt.preventDefault();
    if (isInPage(document.querySelector('.leaflet-popup'))) {
